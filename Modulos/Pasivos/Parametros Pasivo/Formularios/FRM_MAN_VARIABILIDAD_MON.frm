...
Begin VB.Form FRM_MAN_VARIABILIDAD_MON 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantención de Variabilidad de Moneda"
   ClientHeight    =   3570
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5685
   Icon            =   "FRM_MAN_VARIABILIDAD_MON.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VSFlex8LCtl.VSFlexGrid Grd_Ingreso 
      ...
      FormatString    =   $"FRM_MAN_VARIABILIDAD_MON.frx":2EFA
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList Img_opciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":2F4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":33B3
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":38A9
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":3D3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":4224
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":4737
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":4C0A
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":50D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":55C7
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_VARIABILIDAD_MON.frx":5A09
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FRM_MAN_VARIABILIDAD_MON"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'  Autor          : Pamela Farías
'  Descripción    : Mantención de Tipo Variabilidad de Moneda
...
Private Function FUNC_GRABAR_VARIABILIDAD_MONEDA()
...
If Not BAC_SQL_EXECUTE("BEGIN TRANSACTION") Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
     ...
     If .RowHidden(nIndice) = True Then
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_VAR_MONEDA", Envia) Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
      ...
      If .RowHidden(nIndice) = False And Trim(.TextMatrix(nIndice, 0)) <> "" Then
         ...
         If Not BAC_SQL_EXECUTE("SP_ACT_VAR_MONEDA", Envia) Then GoTo Errores
   ...
   Call FUNC_TRAER_VARIABILIDAD_MONEDA
...
Private Function FUNC_TRAER_VARIABILIDAD_MONEDA()

With Grd_Ingreso

      If Not BAC_SQL_EXECUTE("SP_CON_VAR_MONEDA") Then
...
With Grd_Ingreso
 ...
 nCodigo = Trim(.TextMatrix(.Row, 0))
 
 For nIndice = 1 To .Rows - 1
 
   If nCodigo = Trim(.TextMatrix(nIndice, 0)) And nIndice <> .Row And .RowHidden(nIndice) = False Then
   ...
   Case vbKeyDelete
      ...
      If .Row <> 0 Then
        ...
        Else
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_VAR_MONEDA", Envia) Then Exit Sub
...
Select Case Button.Index
   Case 1
         ...
         Call FUNC_GRABAR_VARIABILIDAD_MONEDA
         Grd_Ingreso.SetFocus
