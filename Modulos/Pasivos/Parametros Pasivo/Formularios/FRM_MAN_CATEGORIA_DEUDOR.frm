...
Begin VB.Form FRM_MAN_CATEGORIA_DEUDOR 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantención de Categoría Deudor"
   ClientHeight    =   3150
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5430
   ...
   Begin VSFlex8LCtl.VSFlexGrid Grd_Ingreso 
      ...
      FormatString    =   $"FRM_MAN_CATEGORIA_DEUDOR.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList Ilst_Imagenes 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_CATEGORIA_DEUDOR.frx":0054
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_CATEGORIA_DEUDOR.frx":0F2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_CATEGORIA_DEUDOR.frx":1E08
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FRM_MAN_CATEGORIA_DEUDOR"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'  Autor          : Pamela Farías
'  Descripción    : Mantención de Categoria Deudor
...
Private Function FUNC_GRABAR_CATEGORIA_DEUDOR()
...
If Not BAC_SQL_EXECUTE("BEGIN TRANSACTION") Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
     ...
     If .RowHidden(nIndice) = True Then
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_CATEGORIA_DEUDOR", Envia) Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
      ...
      If .RowHidden(nIndice) = False And Trim(.TextMatrix(nIndice, 0)) <> "" Then
         ...
         If Not BAC_SQL_EXECUTE("SP_ACT_CATEGORIA_DEUDOR", Envia) Then GoTo Errores
   ...
   Call FUNC_TRAER_CATEGORIA_DEUDOR
...
Private Function FUNC_TRAER_CATEGORIA_DEUDOR()

With Grd_Ingreso

      If Not BAC_SQL_EXECUTE("SP_CON_CATEGORIA_DEUDOR") Then
   ...
   Case vbKeyDelete
      ...
      If .Row <> 0 Then
        ...
        Else
               ...
               If Not BAC_SQL_EXECUTE("SP_DEL_CATEGORIA_DEUDOR", Envia) Then Exit Sub
...
Select Case Button.Index
   Case 1
         ...
         Call FUNC_GRABAR_CATEGORIA_DEUDOR
         Grd_Ingreso.SetFocus
