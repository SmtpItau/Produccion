...
Begin VB.Form FRM_MAN_TIPO_INSTRUMENTO 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantención de Tipo de Instrumento"
   ClientHeight    =   3150
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5730
   ...
   Begin VSFlex8LCtl.VSFlexGrid Grd_Ingreso 
      ...
      FormatString    =   $"FRM_MAN_TIPO_INSTRUMENTO.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList Ilst_Imagenes 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_TIPO_INSTRUMENTO.frx":0055
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_TIPO_INSTRUMENTO.frx":0F2F
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRM_MAN_TIPO_INSTRUMENTO.frx":1E09
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FRM_MAN_TIPO_INSTRUMENTO"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'  Autor          : Pamela Farías
'  Descripción    : Mantención de Tipo de Instrumento
...
Private Function FUNC_GRABAR_TIPO_INSTRUMENTO()
...
If Not BAC_SQL_EXECUTE("BEGIN TRANSACTION") Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
     ...
     If .RowHidden(nIndice) = True Then
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_TIPO_INSTRUMENTO", Envia) Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
      ...
      If .RowHidden(nIndice) = False And Trim(.TextMatrix(nIndice, 0)) <> "" Then
         ...
         If Not BAC_SQL_EXECUTE("SP_ACT_TIPO_INSTRUMENTO", Envia) Then GoTo Errores
   ...
   Call FUNC_TRAER_TIPO_INSTRUMENTO
...
Private Function FUNC_TRAER_TIPO_INSTRUMENTO()

With Grd_Ingreso

      If Not BAC_SQL_EXECUTE("SP_CON_TIPO_INSTRUMENTO") Then
   ...
   Case vbKeyDelete
      ...
      If .Row <> 0 Then
        ...
        Else
               ...
               If Not BAC_SQL_EXECUTE("SP_DEL_TIPO_INSTRUMENTO", Envia) Then Exit Sub
...
With Grd_Ingreso
   ...
   If KeyAscii < 48 Or KeyAscii > 57 And Grd_Ingreso.Col = 0 Then
      If KeyAscii <> 13 Then
         KeyAscii = 0
      End If
   End If
...
Select Case Button.Index
   Case 1
         ...
         Call FUNC_GRABAR_TIPO_INSTRUMENTO
         Grd_Ingreso.SetFocus
