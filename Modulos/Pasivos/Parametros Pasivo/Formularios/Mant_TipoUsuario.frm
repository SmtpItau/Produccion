...
Dim SW As Integer
   ...
   If SW = 1 Then MsgBox "La Información a sido Grabada", vbOKOnly + vbInformation
   
   If SW = 2 Then MsgBox "La Información a sido Modificada", vbOKOnly + vbInformation
...
Dim SW As Integer
   ...
   If TxtTipoUsuario.Text <> "" And TxtDescripcion.Text <> "" Then
      ...
      If Grilla.Rows = 2 Then Grilla.Rows = 2
         ...
         TxtTipoUsuario.Text = Grilla.TextMatrix(Grilla.Row, 1)
         TxtDescripcion.Text = Grilla.TextMatrix(Grilla.Row, 2)
         MsgBox "Tipo Usuario Eliminado", vbOKOnly + vbInformation
      
      End If
      
      If SW = 2 Then MsgBox "Error Leyendo " & "SP_Mant_TipoUsuario_Elimina", vbOKOnly + vbInformation
