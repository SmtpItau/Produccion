...
namespace WindowsServiceFMD.Common
{
        ...
        public class ModuleType : IDisposable
        {
            ...
            public ModuleType(DataRow row) {
                if (row != null) {
                    ...
                    this.processType    = (WebServiceFMD.ProcessType)row.Field<int>("process");
                    ...
                    this.require_ny = row.Field<bool>("require_ny");
                    this.db_context = CoreLib.Helpers.JSONHelper.Deserialize<DBContext>(row.Field<string>("db_connection"));
            ...
            /// Tipo de proceso
            /// </summary>
            public WebServiceFMD.ProcessType processType { get; set; }
            ...
            /// <summary>
            /// Indica si se utilizaran los sistemas de nueva york para algunas validaciones.
            /// </summary>
            public bool require_ny { get; set; }
    ...
    namespace Collections
    {
            ...
            : ICollection<T> where T : DTO.ModuleType
        {
            ...
            public T GetModulo(int id_modulo){                
                foreach (T obj in _innerArray) {
                    if (obj.id_modulo == id_modulo) {
                        return obj;
                    }
                }
                return null;            
