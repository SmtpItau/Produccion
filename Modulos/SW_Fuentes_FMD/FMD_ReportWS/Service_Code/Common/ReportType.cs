...
namespace WindowsServiceFMD.Common
{
    ...
    namespace DAO
    {
        ...
        {
            private const string SQLCMD_SELECT = @"SP_UI_REPORTES_ACTIVOS_RCM @ACCION=5 ";
            /// <summary>
            ...
            public static ReportType FindByDescription(DBContext ctx, string reportDescription) {
                ...
                string sqlcmd = SQLCMD_SELECT + "@ID_REPORTE='{0}'";
    ...
    namespace Collections
    {
            ...
            : ICollection<T> where T : DTO.ReportType
        {
            ...
            public T GetReport(int id_reporte){
                
                    foreach (T obj in _innerArray) {
                        if (obj.id_reporte == id_reporte) {
                            return obj;
                        }                    
                    }
                    return null;                
