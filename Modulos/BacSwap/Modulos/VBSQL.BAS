...
Declare Sub SqlClose Lib "VBSQL.OCX" (ByVal DllSqlConn As Long)
Declare Sub SqlFreeLogin Lib "VBSQL.OCX" (ByVal Login As Long)
Declare Function SqlCmd Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, cmd As String) As Long
Declare Function SqlExec Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlResults Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlNextRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlNumCols Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlColName Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As String
Declare Function SqlColType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As Long
Declare Function SqlColUType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As Long
Declare Function SqlColLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As Long
Declare Function SqlDatLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As Long
Declare Function SqlData Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As String
Declare Function SqlColInfo Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal InfoType As Long, ByVal Column As Long, ByVal ComputeId As Long, ColInf As ColInfo) As Long
Declare Function SqlDataReady Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
...
Declare Function SqlSend Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlOk Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlGetChar Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal CharNum As Long) As String
Declare Function SqlStrCpy Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Start As Long, ByVal NumBytes As Long, Buffer As String) As Long
Declare Function SqlStrLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlSetOpt Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Opt As Long, Param As String) As Long
Declare Function SqlClrOpt Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Opt As Long, Param As String) As Long
Declare Function SqlIsOpt Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Opt As Long, Param As String) As Long
Declare Sub SqlFreeBuf Lib "VBSQL.OCX" (ByVal DllSqlConn As Long)
Declare Function SqlCancel Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlCanQuery Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlGetRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RowNum As Long) As Long
Declare Sub SqlClrBuf Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RowNum As Long)
Declare Function SqlColBrowse Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As Long
Declare Function SqlColSource Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal TabNum As Long) As String
Declare Function SqlQual Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal TabNum As Long, TableName As String) As String
Declare Function SqlTabBrowse Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal TabNum As Long) As Long
Declare Function SqlTabCount Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlTabName Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal TabNum As Long) As String
Declare Function SqlTabSource Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ColNum As Long, TabNum As Long) As String
Declare Function SqlTsNewLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlTsNewVal Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As String
Declare Function SqlTsPut Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, NewTs As String, ByVal NewTsLen As Long, ByVal TabNum As Long, TabName As String) As Long
Declare Function SqlMoreText Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Size As Long, Text As String) As Long
Declare Function SqlTxPtr Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As String
Declare Function SqlTxTimeStamp Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Column As Long) As String
Declare Function SqlTxTsNewVal Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As String
Declare Function SqlTxTsPut Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, NewTxTs As String, ByVal Column As Long) As Long
Declare Function SqlWriteText Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ObjName As String, TextPtr As String, ByVal TextPtrLen As Long, TimeStamp As String, ByVal Logging As Long, ByVal Size As Long, Text As String) As Long
Declare Function SqlUpdateText Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ObjName As String, TextPtr As String, TimeStamp As String, ByVal UType As Long, ByVal Offset As Long, ByVal DelLen As Long, SrcName As String, ByVal Size As Long, Text As String) As Long
Declare Function SqlCmdRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlIsCount Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlCount Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlCurCmd Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlCurRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlDead Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlFirstRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlGetTime Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlIsAvail Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlLastRow Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlMoreCmds Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlNumOrders Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlRows Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlRowType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlNumAlts Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long) As Long
Declare Function SqlAltType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlAltUType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlAltLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlADLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlAData Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As String
Declare Function SqlAltColId Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlAltOp Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long, ByVal Column As Long) As Long
Declare Function SqlByList Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ComputeId As Long) As String
Declare Function SqlNumCompute Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlUse Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, DataBase As String) As Long
Declare Function SqlGetOff Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal OffType As Long, ByVal StartFrom As Long) As Long
Declare Function SqlOrderCol Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Order As Long) As Long
Declare Function SqlChange Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As String
Declare Function SqlGetMaxProcs Lib "VBSQL.OCX" () As Long
Declare Function SqlName Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As String
Declare Function SqlPrType Lib "VBSQL.OCX" (ByVal Token As Long) As String
Declare Sub SqlSetAvail Lib "VBSQL.OCX" (ByVal DllSqlConn As Long)
Declare Function SqlSetMaxProcs Lib "VBSQL.OCX" (ByVal MaxProcs As Long) As Long
Declare Function SqlBCPColfmt Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal FColumn As Long, ByVal FType As Long, ByVal FPLen As Long, ByVal FCLen As Long, FTerm As String, ByVal FTLen As Long, ByVal TCol As Long) As Long
Declare Function SqlBCPColumns Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal ColCount As Long) As Long
Declare Function SqlBCPControl Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal Param As Long, ByVal Value As Long) As Long
Declare Function SqlBCPExec Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, RowsCopied As Long) As Long
Declare Function SqlBCPInit Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, TblName As String, hFile As String, ErrFile As String, ByVal Direction As Long) As Long
Declare Function SqlBCPSetL Lib "VBSQL.OCX" (ByVal loginrec As Long, ByVal Enable As Long) As Long
Declare Function SqlBCPDone Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlSendCmd Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, cmd As String) As Long
Declare Function SqlGetColumnInfo Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, Col As ColumnData, ByVal Column As Long) As Long
Declare Function SqlGetAltColInfo Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, AltCol As AltColumnData, ByVal ComputeId As Long, ByVal AltColumn As Long) As Long
...
Declare Function SqlTextUpdate1Row Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ObjName As String, ByVal Column As Long, Text As String) As Long
Declare Function SqlTextUpdateManyRows Lib "VBSQL.OCX" (ByVal QDllSqlConn As Long, ByVal UDllSqlConn As Long, ObjName As String, ByVal Column As Long, Text As String) As Long
Declare Function SqlBCPColumnFormat Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, Col As BcpColData, ByVal NumCols As Long) As Long
Declare Function SqlTsUpdate Lib "VBSQL.OCX" (ByVal QDllSqlConn As Long, ByVal UDllSqlConn As Long, ByVal TabNum As Long, TabName As String) As Long
'Declare Function SqlCursorOpen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, Statement As String, ByVal ScrollOpt As Long, ByVal ConCurOpt As Long, ByVal nRows As Long, PStat As Long) As Long
Declare Function SqlCursorOpen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, Statement As String, ByVal ScrollOpt As Long, ByVal ConCurOpt As Long, ByVal nRows As Long) As Long
...
Declare Function SqlDateCrack Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, SqlDateInfo As DateInfo, DateTime As String) As Long
Declare Function SqlHasRetStat Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlNumRets Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlRetData Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RetNum As Long) As String
Declare Function SqlRetLen Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RetNum As Long) As Long
Declare Function SqlRetName Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RetNum As Long) As String
Declare Function SqlRetStatus Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlRetType Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ByVal RetNum As Long) As Long
Declare Function SqlRpcInit Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, RpcName As String, ByVal Options As Long) As Long
Declare Function SqlRpcParam Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ParamName As String, ByVal Status As Long, ByVal ParamType As Long, ByVal MaxLen As Long, ByVal DataLen As Long, Value As String) As Long
Declare Function SqlRpcSend Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlRpcExec Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
...
Declare Function SqlGetPacket Lib "VBSQL.OCX" (ByVal DllSqlConn As Long) As Long
Declare Function SqlProcInfo Lib "VBSQL.OCX" (ByVal DllSqlConn As Long, ProcInf As ProcInfo) As Long
