    ...
    If giAceptar = True Then
        ...
        If Bac_Sql_Execute("Sva_Vnt_grb_ope", envia) Then
            ...
            If Numoper <> 0 Then
                ...
                resControlPT = ControlPreciosTasas("VPX", ptInstr, ptPlazo, ptTasa, False)
                ...
                Else
                    'grabar en Control Financiero ssi EnviarCF = "S"
                    If EnviarCF = "S" Then
                    Ctrlpt_codProducto = "VPX"
                    Ctrlpt_NumOp = Numoper
                    Ctrlpt_NumDocu = ""
                ...
                MsgBox "Operación Grabada Con el Número " & Numoper & Mensaje_CPT, vbInformation, gsBac_Version
                MousePointer = 11
