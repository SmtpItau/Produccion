...
{
    /// <summary>
    /// Descripción breve de TuringSAO
    /// </summary>
    ...
    public class TuringSAO : System.Web.Services.WebService
    {

        [WebMethod]
        public string InsertOptionSAO(string xdocInsert, string NomUser, string Estado, int NumFolio
                                  , int NumContrato, DateTime fProceso)
        {
            ...
            return _resutLCR;  //_Tipo + " " + _result + " " + _resutLCR;
        }
        ...
        [WebMethod]
        public string RecuperaContratoSAO(int NumContrato, int NumFolio)
        {
        ...
        [WebMethod]
        public string UpdateOptionSAO(string xdocInsert)
        {
            try
            {
                string _result = string.Empty;
        ...
        [WebMethod]
        public string UpdateFlagValuatorSAO()
        {
            string _Value = "";
            try
            {
