...
namespace Turing2009Data.Sensibilities.Results
{
    ...
    public class PortfolioResultsFixingIncome : InterfaceQuery
    {
        ...
        public DataTable Load(string conditions)
        {
            ...
            _FixingIncome += "     , 'Estimation'              = SUM( CASE WHEN SFR.contractdate = SD.sensibilitiesdate THEN 0.0 ELSE SD.estimationvalue END )\n";
