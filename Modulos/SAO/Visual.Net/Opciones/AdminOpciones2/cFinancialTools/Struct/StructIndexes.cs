...
#region "Constructores"
        ...
        public StructIndexes(long numberflow, DateTime startingdate, DateTime expirydate, DateTime paymentdate, DateTime fixingdate)
        {
            SetValue(numberflow, startingdate, expirydate, paymentdate, fixingdate);
        }

        public StructIndexes(DateTime startingdate, DateTime expirydate, DateTime paymentdate, DateTime fixingdate)
        {
            SetValue(0, startingdate, expirydate, paymentdate, fixingdate);
        }

        public StructIndexes()
        {
