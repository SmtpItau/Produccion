...
namespace AdminOpciones.OpcionesFX.Front
{
    public partial class FontOpciones
    {
        ...
        private void Estructura_Butterfly(string vanilla_asiatica, string Fijaciones, string estructura, string payoff, double PuntosCosto, DateTime fecha_Val, DateTime fecha_Vencto, string call_put, string paridad, string compra_venta, double nocional, double spot, string Strikes_Delta_Valores_XML, string YieldNameDom, string YieldNameFor, int FlagSmile)
        {
            ...
            _SrvEstructura.ButterflyCompleted += new EventHandler<AdminOpciones.SrvEstructura.ButterflyCompletedEventArgs>(_SrvEstructura_ButterflyCompleted);
            _SrvEstructura.ButterflyAsync(this.strikes_delta_flag, vanilla_asiatica, BsSpot_BsFwd_AsianMomentos_flag, Fijaciones, estructura, this.checkBoxVegaWeighted.IsChecked.Value, NocionalStrangle, payoff, PuntosCosto, fecha_Val, fecha_Vencto, FechaSetdePrecios, call_put, paridad, compra_venta, nocional, spot, this.BSSpotValorizacion, Strikes_Delta_Valores_XML, YieldNameDom, YieldNameFor, setPrecios_Pricing);

            RefreshSetPricing();
        }

        private void _SrvEstructura_ButterflyCompleted(object sender, AdminOpciones.SrvEstructura.ButterflyCompletedEventArgs e)
        {
