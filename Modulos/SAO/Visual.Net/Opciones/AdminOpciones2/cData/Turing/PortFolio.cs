...
namespace cData.Turing
{
    ...
    public class PortFolio
    {
        ...
        public DataTable Load(string portFolio)
        {
            ...
            switch (mSource)
            {
                case enumSource.System:
                    ...
                    _PortFolio = _System.Load(portFolio);
                ...
                case enumSource.Bloomberg:
                    ...
                    _PortFolio = _Bloomberg.Load(portFolio);
                ...
                case enumSource.Excel:
                    ...
                    _PortFolio = _Excel.Load(portFolio);
        ...
        private class Source
        {
            ...
            public virtual DataTable Load(string portFolio)
            {
                DataTable _PortFolio = new DataTable();
        ...
        private class SourceSystem : Source
        {
            ...
            public override DataTable Load(string portFolio)
            {
