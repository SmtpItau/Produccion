...
namespace cData.AccionesBD
{
    public static class Acciones
    {
        ...
        public static DataTable UpdateFlagValorizacion()
        {
            ...
            #region "Ejecuta sp_actualizaflagvalorizacion"
        ...
        {
            #region "variables GrabaContrato"
            string _CodigoRelacion = "0" ;//Prd_16803
            string _Result = string.Empty,
                    MoTipoPayOff = string.Empty;
            Int64 MoNumFolio = 0,
                    MoNumContrato = 0,
            ...
            try
            {
                ...
                if (_Datos.Tables.Count > 0)
                {
                    ...
                    _newRow.MoRelacionaPAE = _row["MoRelacionaPAE"] != "" && _row["MoRelacionaPAE"].ToString() != "NaN" ? Int32.Parse(_row["MoRelacionaPAE"].ToString()) : 0;
                    //Prd_16803
                    _CodigoRelacion = _row["MoRelacionaLeasing"] != "" && _row["MoRelacionaLeasing"].ToString() != "NaN" ? _row["MoRelacionaLeasing"].ToString() : "0";
                    //Prd_10968
                    _Rut = MoRutCliente;
                    ...
                    //PRD_12567 _newRow.MoDeltaForwardCont = _row["MoDeltaForwardCont"] != "" && _row["MoDeltaForwardCont"].ToString() != "NaN" ? Double.Parse(_row["MoDeltaForwardCont"].ToString()) : 0;
                    _newRow.MoDeltaForwardCont = _row["MoDeltaForwardCont"] != "" && _row["MoDeltaForwardCont"].ToString() != Double.NaN.ToString() ? Double.Parse(_row["MoDeltaForwardCont"].ToString()) : 0;
                    ...
                    if (_Datos.Tables["detContrato"] != null)
                    {
                        foreach (DataRow _rowD in _Datos.Tables["detContrato"].Rows)
                        {
                            try
                            {
                                ...
                                _newRowD.MoMdaCompensacion = _rowD["MoMdaCompensacion"] != "" ? Int64.Parse(_rowD["MoMdaCompensacion"].ToString()) : 0;
                                _newRowD.MoBenchComp = _rowD["MoBenchComp"] != "" ? Int64.Parse(_rowD["MoBenchComp"].ToString()) : 0;
                                //_newRowD.MoPorcStrike = _rowD["MoPorcStrike"] != "" ? Int64.Parse(_rowD["MoPorcStrike"].ToString()) : 0; //PRD_12567
                                _newRowD.MoIteAsoCon = _rowD["MoIteAsoCon"] != "" ? Int64.Parse(_rowD["MoIteAsoCon"].ToString()) : 0;
                                _newRowD.MoFormaPagoComp = _rowD["MoFormaPagoComp"] != "" ? Int64.Parse(_rowD["MoFormaPagoComp"].ToString()) : 0;
                                ...
                                _newRowD.MoPorcStrike = _rowD["MoPorcStrike"] != "" ? __ConvertDecimal(_rowD["MoPorcStrike"].ToString()):0;//PRD_12567
            ...
            //Prd_16803
            #region Graba Relacion
            //switch (_CodigoRelacion)
            //{
            //    case "3":
            //        try
            //        {
            //          GrabaRelacionLeasingSao(_Datos, MoNumFolio, MoNumContrato);
            //        }
            //        catch { }
            //        break;
            //}
        ...
        {
            return value != "" && value.ToUpper() != "NAN" && value.ToUpper() != "NEUN" ? double.Parse(value) : 0;
        }

        public static decimal __ConvertDecimal(string value)
        {
            return value != "" && value.ToUpper() != "NAN" && value.ToUpper() != "NEUN" ? decimal.Parse(value) : 0;
        }
        ...
        public static String ModificaContrato(DataSet _Datos, string Usuario_, int _NumFolio, int _NumContrato)
        {
                ...
                if (_Datos.Tables.Count > 0)
                {
                    ...
                    if (_Datos.Tables["detContrato"] != null)
                    {
                        foreach (DataRow _rowD in _Datos.Tables["detContrato"].Rows)
                        {
                            ...
                            _newRowD.MoMdaCompensacion = _rowD["MoMdaCompensacion"] != "" ? Int64.Parse(_rowD["MoMdaCompensacion"].ToString()) : 0;
                            _newRowD.MoBenchComp = _rowD["MoBenchComp"] != "" ? Int64.Parse(_rowD["MoBenchComp"].ToString()) : 0;
                            //PRD_12567 reciclamos campo para guardar Spread sobre observado, puede ser con decimales por lo que se ubica abajo.
                            //_newRowD.MoPorcStrike = _rowD["MoPorcStrike"] != "" ? Int64.Parse(_rowD["MoPorcStrike"].ToString()) : 0;
                            _newRowD.MoIteAsoCon = _rowD["MoIteAsoCon"] != "" ? Int64.Parse(_rowD["MoIteAsoCon"].ToString()) : 0;
                            _newRowD.MoFormaPagoComp = _rowD["MoFormaPagoComp"] != "" ? Int64.Parse(_rowD["MoFormaPagoComp"].ToString()) : 0;
                            ...
                            //PRD_12567 reciclamos campo para guardar Spread sobre observado, puede ser con decimales.
                            _newRowD.MoPorcStrike = _rowD["MoPorcStrike"] != "" ? __ConvertDecimal(_rowD["MoPorcStrike"].ToString()) : 0; //OK
            ...
            //        try
            //        {
            //            ModificaRelacionLeasingSao(_Datos, MoNumFolio, MoNumContrato);
            //        }
            //        catch { }
            //        break;                  
            //}
        ...
        /// <summary>
        /// Ejecuta CbMdbOpc..Sp_AppMvtCar
        /// </summary>
        /// <param name="_NumFolio"></param>
        /// <returns></returns>
        public static DataTable ProcesoAppMvtCar(int _NumFolio)
        {
            String _Query = "Sp_AppMvtCar " + _NumFolio;

            cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("OPCIONES");
            DataTable _AccionUpdate;

            #region "Ejecuta CbMdbOpc..Sp_AppMvtCar"
            try
            {
                mStatus = enumStatus.Loading;
                _Connect.Execute(_Query);
        ...
        public static String ActualizaCartera(DataSet _Datos)
        {
                    ...
                    foreach (DataRow _rowData in _Datos.Tables["detContrato"].Rows)
                    {
                        try
                        {
                            ...
                            try
                            {
                                ...
                                //PRD_12567 para grabar campos
                                orow_.CaStrike = CheckValue(_rowData["MoStrike"].ToString());                // MAP 20130220
                                orow_.CaMontoMon2 = (decimal)CheckValue(_rowData["MoMontoMon2"].ToString()); // MAP 20130220
                                orow_.EndEdit();
                            }
                            catch (Exception e)
                            {
                            ...
                            //ASVG_20130916 URGENTE REVISAR las comillas.
                            string _KeyDataFixing = string.Format(
                                                                   "MoNumContrato = '{0}' AND MoNumEstructura = '{1}'",
                                                                   _rowData["NumContrato"].ToString(),
                                                                   _rowData["NumEstructura"].ToString()
                                                                 );
                            DataRow[] _DRFixings = _Datos.Tables["FixingData"].Select(_KeyDataFixing, "ID");
            ...
            {
                _Result = "Error preparando actualización: " + _Error.Message + " " + _Contrato.ToString();
            ...
            try
            {
                if (datos.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow _rowData in datos.Tables["detContrato"].Rows)
                    {
                        ...
                        //ASVG_20130916 URGENTE REVISAR tipos de dato de DataTables
                        //Con comillas se cae cuando hay 1000 o ms fijaciones.
                        //Sin comillas se cae al parecer por desorden de fijaciones.
                        string _Key = string.Format(
                                                     "CaNumContrato = '{0}' AND CaNumEstructura = '{1}'",
                                                     _rowData["NumContrato"].ToString(),
                                                     _rowData["NumEstructura"].ToString()
        ...
        /// <summary>
        /// Genera y graba grupos de impresión para pasarle al RPT.
        /// </summary>
        ...
        //Prd_10968
        /// <summary>
        /// Trae datos paramétricos de Cliente: rut, codigo, nombre, MetodologiaLCR, Mto_Lin_Threshold, dv, pais.
        /// Ejecuta CbMdbOpc..SP_CON_CLIENTE_LCR
        /// </summary>
        /// <param name="_Datos"></param>
        /// <param name="_Operacion"></param>
        /// <returns></returns>
        public static DataTable TraeClienteLCR(DataSet _Datos, string _Operacion)
        {
            ...
            #region "Ejecuta CbMdbOpc..SP_CON_CLIENTE_LCR"
        ...
        /// <summary>
        /// Ejecuta LnkBac.BacLineas.dbo.SP_EJECUCION_PROCESOS_LINEAS_OPCIONES_PTONET
        /// </summary>
        /// <param name="_Resultado"></param>
        /// <param name="_Datos"></param>
        /// <param name="Usuario_"></param>
        /// <param name="_NumContrato"></param>
        /// <param name="_Operacion"></param>
        /// <param name="InyectaTuring"></param>
        /// <returns></returns>
        public static string EjecutaProcesoLineasOpciones(DataTable _Resultado, DataSet _Datos,
                                                          string Usuario_, int _NumContrato, string _Operacion, int InyectaTuring)
        {
            ...
            if (_Metodologia == 2 | _Metodologia == 3 | _Metodologia == 5)
            {
                if (_Resultado != null)
                {
                    ...
                    _PorcAddOn = Convert.ToDouble(_R["PorcAddOn"].ToString());
            ...
            else
            {
                if (_Resultado != null)
                {
                    ...
                    _PorcAddOn = Convert.ToDouble(_R["Porcentaje_AddOn"].ToString());
            ...
            try
            {
                ...
                string estadoGrb = "1"; //PRD_13053 REVISAR
                ...
                {
                    mStatus = enumStatus.Already;
                    estadoGrb = "0"; //PRD_13053 REVISAR
                }

 //PRD_13053 REVISAR
               //TURING  >>>>>
                if (_Sistema == "OPT" && InyectaTuring == 1)
                {                      
        ...
        /// <summary>
        /// Ejecuta CbMdbOpc..SP_Calculo_LCR_Interno_Opciones
        /// </summary>
        /// <param name="_NumContrato"></param>
        /// <param name="_Operacion"></param>
        /// <returns></returns>
        public static DataTable CalculaLCROpciones(int _NumContrato, string _Operacion)
        {
            ...
            #region "Ejecuta SP_Calculo_LCR_Interno_Opciones"
        ...
        /// <summary>
        /// Invoca DLLBacCalculoREC, función: ProcesoCalculoRECFunDLL
        /// </summary>
        /// <param name="_RutRec"></param>
        /// <param name="_CodCliRec"></param>
        /// <param name="_DescClienteRec"></param>
        /// <param name="_ThresholdRec"></param>
        /// <param name="_Rec_metodologia"></param>
        /// <returns>Monto REC. A imputar o imputado??</returns>
        public static double EjecutaCalculoRec(int _RutRec, int _CodCliRec, string _DescClienteRec, double _ThresholdRec, short _Rec_metodologia)
        {
            ...
            //ASVG_20150109 Validación de Guid de referencia, no deben cambiar por compatibilidad binaria. (falta investigar)
            //[CoClass(typeof(CLSBacCalculoRECClass))] --> [Guid("E23D5BAF-E0BC-4C51-BC85-B968246C6360")]
            //[TypeLibType(4304)] --> [Guid("E23D5BAF-E0BC-4C51-BC85-B968246C6360")] --> public interface _CLSBacCalculoREC
            //[ClassInterface(0)] --> [Guid("0FDC1990-594E-4581-880E-F4403AA5D414")] --> [TypeLibType(2)] --> public class CLSBacCalculoRECClass : _CLSBacCalculoREC, CLSBacCalculoREC
        ...
        //Inicio Rq_13090
        #region SDA
        public static DataTable InsertaSolicitudSDA(string NumContrato, DateTime FechaIngreso, DateTime FecActivacion, 
                                                    string MontoAnticipo, string FormaPago, string TipoAnticipo)
        {
            ...
            #region "Ejecuta SP_GRABAR_SOLICITUD_SDA"
            _Query = "SP_GRABAR_SOLICITUD_SDA " + NumContrato + " ,'" + FechaIngreso.ToString("yyyyMMdd") + "' ,'" + FecActivacion.ToString("yyyyMMdd") 
                                                + "'," + MontoAnticipo.Replace(",",".") + "," + FormaPago + ",'" + TipoAnticipo + "'";
            #endregion
            ...
            try
            {
                ...
                _Connect.Execute(_Query);
                _AccionUpdate = _Connect.QueryDataTable();
                _AccionUpdate.TableName = "Ingreso Solicitud";
        ...
        public static DataTable AnticipaOP_SDA(string fechaProxAP, string User)
        {
            String _Query = "";
            ...
            #region "SP_PREPARA_ACCION_CON_SDA"
            _Query = "SP_PREPARA_ACCION_CON_SDA '" + fechaProxAP + "','" + User + "'";
            #endregion
        ...
        public static DataTable ConValidacion_SDA(string NumContrato, DateTime FechaActivacion, string NumFolio)
        {
            String _Query = "";
            ...
            #region "SP_VALIDA_SOLICITUD_SDA"
            _Query = "SP_VALIDA_SOLICITUD_SDA " + NumContrato + ",'" + FechaActivacion.ToString("yyyyMMdd") + "'," + NumFolio + "";
            #endregion
        ...
        public static DataTable Anula_SDA(string NumContrato, string NumSolicitud)
        {
            String _Query = "";
            ...
            #region "SP_ANULA_SDA"
            _Query = "SP_ANULA_SDA '" + NumContrato + "','" + NumSolicitud + "'";
            #endregion
        ...
        public static DataTable ModicicaSolicitudSDA( string NumFolio, string NumContrato, DateTime FechaIngreso, DateTime FecActivacion,
                                                  string MontoAnticipo, string FormaPago, string TipoAnticipo)
        {
            ...
            #region "Ejecuta SP_ACTUALIZA_SOLICITUD_SDA"
            _Query = "SP_ACTUALIZA_SOLICITUD_SDA " + NumFolio + " ," + NumContrato + " ,'" + FechaIngreso.ToString("yyyyMMdd") + "' ,'" + FecActivacion.ToString("yyyyMMdd")
                                                + "'," + MontoAnticipo.Replace(",",".") + "," + FormaPago + ",'" + TipoAnticipo + "'";
            ...
            try
            {
                ...
                _Connect.Execute(_Query);
                _AccionUpdate = _Connect.QueryDataTable();
                _AccionUpdate.TableName = "Modifica Solicitud";
        ...
        public static DataTable Graba_SP_Registro_ingreso_operacion(string Aplicacion,string Pantalla,string ModuloBac, int NumContrato,DateTime FechaSys)
        {
            String _Query = "";
            cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("BACPARAMSUDA");
            DataTable _AccionUpdate;

            #region "Ejecuta SP_Registro_ingreso_operacion"
            _Query = "SP_Registro_ingreso_operacion '" + Aplicacion + "' ,'" + Pantalla + "' ,'" + ModuloBac + "' ," + NumContrato + " ,'" + FechaSys.ToString("yyyyMMdd") + "'";
            #endregion
        ...
        #region 16803
        //Prd_16803
        //private static void GrabaRelacionLeasingSao(DataSet _Datos, Int64 MoNumFolio, Int64 MoNumContrato)
        //{
        //    DataRow _row = _Datos.Tables["encContrato"].Rows[0];

        //    string MoRelacionaLeasing = _row["MoRelacionaLeasing"] != "" && _row["MoRelacionaLeasing"].ToString() != "NaN" ? _row["MoRelacionaLeasing"].ToString() : "0";
        //    string MoNumeroLeasing = _row["MoNumeroLeasing"] != "" && _row["MoNumeroLeasing"].ToString() != "NaN" ? _row["MoNumeroLeasing"].ToString() : "0";
        //    string MoNumeroBien = _row["MoNumeroBien"] != "" && _row["MoNumeroBien"].ToString() != "NaN" ? _row["MoNumeroBien"].ToString() : "0";
        ...
        //    #region "Ejecuta SP_INSERTA_RELACION_SAO_LEASING"
        //    _Query = "SP_INSERTA_RELACION_SAO_LEASING " + MoNumeroLeasing + " ," + MoNumeroBien + " ," 
        //                                                + MoNumContrato   + " ," + MoNumFolio ;
        ...
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "Ingreso Relacion";
        ...
        //PRD_16803
        //private static void ModificaRelacionLeasingSao(DataSet _Datos, Int64 MoNumFolio, Int64 MoNumContrato)
        //{

        //    DataRow _row = _Datos.Tables["encContrato"].Rows[0];
          
        //    string MoRelacionaLeasing = _row["MoRelacionaLeasing"].ToString() != "" && _row["MoRelacionaLeasing"].ToString() != "NaN" ? _row["MoRelacionaLeasing"].ToString() : "0";
        //    string MoNumeroLeasing = _row["MoNumeroLeasing"].ToString() != "" && _row["MoNumeroLeasing"].ToString() != "NaN" ? _row["MoNumeroLeasing"].ToString() : "0";
        //    string MoNumeroBien = _row["MoNumeroBien"].ToString() != "" && _row["MoNumeroBien"].ToString() != "NaN" ? _row["MoNumeroBien"].ToString() : "0";
        ...
        //    #region "Query"
        //    _Query  = "BEGIN TRY\n";
        //    _Query += "UPDATE TBL_RELACION_SAO_LEASING\n";
        //    _Query += "SET    ReNumeroLeasing = " + MoNumeroLeasing + "\n";
        //    _Query += ",      ReNumeroBien = " + MoNumeroBien + "\n";
        //    _Query += "WHERE  ReCaNumContrato = " + MoNumContrato + "\n";
        //    _Query += "SELECT 'Resultado' = CAST(@@ERROR AS NVARCHAR(100))\n";
        //    _Query += "END TRY\n";
        //    _Query += "BEGIN CATCH\n";
        //    _Query += "SELECT 'Resultado' = CAST(@@ERROR AS NVARCHAR(100))\n";
        //    _Query += "END CATCH\n";
        ...
        //        _Connect.Execute(_Query);               
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "Modifica";
        ...
        //PRD_16803
        //public static DataTable GrabaListaLeasing(string XmlListaLeasing, string FechaProceso)
        //{
        //    string _Query = "";
                                            
        //    XmlDocument xDoc = new XmlDocument();

        //    xDoc.LoadXml(XmlListaLeasing);
        //    XmlNodeList Process = xDoc.GetElementsByTagName("datosLesingAsociado"); //REVISAR OK
        //    cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("OPCIONES");
        //    DataTable _AccionUpdate;
        ...
        //    if (Process.Count > 0)
        //    {
        //        _Query =  "DECLARE @Existe INT\n";
        //        _Query += "SET @Existe = 0\n";
        //        _Query += "SELECT  @Existe = 1 FROM Leasing_Relacionados_OPT WHERE CONVERT(VARCHAR(10),Fecha_Carga,112) = '" + FechaProceso + "'\n";
        //        _Query += "IF @Existe = 1\n";
        //        _Query += "BEGIN\n";
        //        _Query += "     DELETE FROM Leasing_Relacionados_OPT WHERE fecha_carga = '" + FechaProceso + "'\n";
        //        _Query += "END\n\n";

        //        _Query += "BEGIN TRANSACTION\n";
        //        _Query += "BEGIN TRY\n";
                           
        //        foreach (XmlElement nodo in Process)
        //        {
        //            string numero_leasing = (nodo.GetElementsByTagName("NumeroLeasing").Item(i).InnerText);
        //            string numero_grupo_bien = (nodo.GetElementsByTagName("NumeroGrupoBienes").Item(i).InnerText);
        //            string numero_fwd_relacion = (nodo.GetElementsByTagName("numeroForward").Item(i).InnerText) == "" ? "0" : (nodo.GetElementsByTagName("numeroForward").Item(i).InnerText);
        
        //            #region "Inserta Leasing_Relacionados_OPT"
        //            //_Query = "SP_INSERTA_LISTA_LEASING " + numero_leasing + " ," + numero_grupo_bien + " ,"
        //            //                                     + numero_fwd_relacion ;

        //            _Query += "     INSERT INTO Leasing_Relacionados_OPT VALUES (" + numero_leasing + " ," + numero_grupo_bien + " , " + numero_fwd_relacion + " ,'" + FechaProceso + "')\n";
        ...
        //        _Connect.Execute(_Query);                    
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "ListaLeasing";
        ...
        //public static DataTable ValidaFechaListaLeasing(string FechaProceso)
        //{
        //    string _Query = "";                                                     
        //    cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("OPCIONES");
        //    DataTable _AccionUpdate;
        ...
        //        _Query += "SET @Existe = 0\n";
        //        _Query += "SELECT  @Existe = 1 FROM LEASING_RELACIONADOS_OPT WHERE CONVERT(VARCHAR(10),fecha_carga,112) = '" + FechaProceso + "'\n";
        //        _Query += "SELECT 'Resultado'=@Existe\n";
        //    #endregion Query
        ...
        //        _Connect.Execute(_Query);                    
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "FechaLeasing";
        ...
        /// </summary>
        /// <returns></returns>
        //public static DataTable TraeDatosGeneralesOpciones()
        //{
        //    string _Query = "";
        //    cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("OPCIONES");
        //    DataTable _AccionUpdate;
        ...
        //    #region Query
        //    _Query = " SELECT	 entidad, codigo, nombre,rut,direccion,comuna,ciudad,telefono,fax,fechaant,fechaproc\n";
        //    _Query += ",fechaprox,numero_Contrato,numero_Folio,rutbcch,iniciodia,findia,cierreMesa,devengo,Vencimientos\n";
        //    _Query += ",Fijacion,VoucherNumero,RutaIntCon,RutaIntSigir,CargaParamSudaCierre\n";
        //    _Query += "FROM	OpcionesGeneral\n";
        //    #endregion Query
        ...
        //        _Connect.Execute(_Query);
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "DatosOpciones";
        ...
        /// <returns></returns>
        //public static DataTable ValidarelacionLeasing(string NumOperacion)
        //{
        //    string _Query = "";
        //    cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("OPCIONES");
        //    DataTable _AccionUpdate;
        ...
        //    #region Query
        //    _Query = "DECLARE @NumFolio NUMERIC (8,0)\n";
        //    _Query += "SET @NumFolio = 0\n";
        //    _Query += "SELECT @NumFolio = Ca.CaNumFolio FROM CaEncContrato Ca\n";
        //    _Query += "INNER JOIN TBL_RELACION_SAO_LEASING Leasing ON Ca.CaNumContrato = Leasing.ReCaNumContrato\n";
        //    _Query += "WHERE Ca.CaNumContrato = " + NumOperacion;
        //    _Query += "SELECT 'NumFolio' = @NumFolio\n ";
        //    #endregion Query
        ...
        //        _Connect.Execute(_Query);
        //        _AccionUpdate = _Connect.QueryDataTable();
        //        _AccionUpdate.TableName = "Relacionleasing";
        ...
        public static DataTable Obtener_Transaccion_Tabla_IDD(string Aplicacion, string modulo, int numOp, int numDoc, int correlativo)
        {
            String _Query = "";
            cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("BACLINEAS");
            DataTable _return;

            #region "Ejecuta SP_TRAE_DATOS_OPERACION_IDD"
            _Query = "SP_TRAE_DATOS_OPERACION_IDD '" + Aplicacion + "' ,'" + modulo + "' ," + numOp + " ," + numDoc+ " ," + correlativo + "";
            #endregion
            ...
            try
            {
                mStatus = enumStatus.Loading;
                _Connect.Execute(_Query);
                _return = _Connect.QueryDataTable();
                _return.TableName = "Transaccion IDD";

                if (_return.Rows.Count.Equals(0))
                {
                    mStatus = enumStatus.NotFound;
                }
                else
        ...
        public static string Actualiza_Transaccion_Tabla_IDD(int statusIDD, string Aplicacion, string modulo, int numOp, int numDoc, int correlativo, string mensajeIDD, int numeroIDD, int controlLinea)
        {
            String _Query = "";
            cConnectionDB.SqlConnectionDB _Connect = new cConnectionDB.SqlConnectionDB("BACLINEAS");
            
            string _result = "";
            #region "Ejecuta SP_ACTUALIZA_DATOS_OPERACION_IDD"
           // _Query = "SP_ACTUALIZA_DATOS_OPERACION_IDD " + Aplicacion + ",'" + Aplicacion + "' ,'" + modulo + "' ," + numOp + " ," + numDoc + " ," + correlativo + ",'" + mensajeIDD + "'," + numeroIDD + "," + controlLinea;
            _Query = "SP_ACTUALIZA_DATOS_OPERACION_IDD " + statusIDD + ",'" + Aplicacion + "' ,'" + modulo + "' ," + numOp + " ," + numDoc + " ," + correlativo + ",'" + mensajeIDD + "'," + numeroIDD + "," + controlLinea;
            #endregion
            ...
            try
            {
                ...
                _Connect.Execute(_Query);
                    ...
                    mStatus = enumStatus.Already;
                    if (statusIDD == 200)
                        _result = " Codigo " + numeroIDD.ToString() + " Estado OK ";
                    else if (statusIDD == 205)
                        _result = mensajeIDD;
                    else
                        _result = " Se registro con problema con detalle " + mensajeIDD + " ";
             }
            catch (Exception _Error)
            {
