...
'        MsgBox ("Fecha de capitalización no puede ser menor o igual a fecha de Otorgamiento"), vbOKOnly + vbInformation
'        TXT_Fecha_Capitaliza.Text = TXT_Fecha_Otor.Text
'
'    ElseIf CDate(TXT_Fecha_Cuota.Text) <= CDate(TXT_Fecha_Capitaliza.Text) Then
'
'        MsgBox ("Fecha capitalización no puede ser mayor o igual a fecha de primera cuota"), vbOKOnly + vbInformation
'        TXT_Fecha_Capitaliza.Text = TXT_Fecha_Otor.Text
'
'    Else
      ...
      Else
         ...
         Do While FUNC_LEE_RETORNO_SQL(vDatos_Retorno())
            ...
            If vDatos_Retorno(36) = -1 Then
                TXT_Fecha_Capitaliza.Text = vDatos_Retorno(35) '[FECHA COLOCACIÓN]
