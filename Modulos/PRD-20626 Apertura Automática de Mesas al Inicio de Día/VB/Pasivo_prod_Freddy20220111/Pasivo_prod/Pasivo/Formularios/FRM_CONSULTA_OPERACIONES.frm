   ...
   Begin MSComctlLib.Toolbar Tlb_Consulta 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button4 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            Object.ToolTipText     =   "Modificar Operación"
            ImageIndex      =   12
         EndProperty
...
Private Sub Tlb_Consulta_ButtonClick(ByVal Button As MSComctlLib.Button)
   ...
   Select Case Button.Key
       ...
       Case "Modificar": Call PROC_MODIFICA_OPERACIONES
...
Dim nFila As Integer
   ...
   If nCont <> 1 Then
      ...
      Tlb_Consulta.Buttons(4).Enabled = False

   Else
      Tlb_Consulta.Buttons(3).Enabled = True
      Tlb_Consulta.Buttons(4).Enabled = True
...
Dim Valor_Colocacion_G   As Double
...
Total_op = 0
   ...
   If Trim(cTipo_Producto) = "BONOS" Or Trim(cTipo_Producto) = "LETRA" Then
    ...
    Valor_Colocacion_G = 0
            ...
            With FRM_ING_BONOS.Grd_Compra_Bonos
               ...
               Else
                  ...
                  Do While FUNC_LEE_RETORNO_SQL(vDatos_Retorno())
                     ...
                     Valor_Colocacion_G = Format(vDatos_Retorno(15), IIf(vDatos_Retorno(14) <> 999 Or vDatos_Retorno(14) <> 998 Or vDatos_Retorno(14) <> 994, GLB_Formato_Dec_USD, GLB_Formato_Entero))
                  Loop
      ...
      FRM_ING_BONOS.TLB_Menu.Buttons(2).Enabled = False
      FRM_ING_BONOS.TLB_Menu.Buttons(3).Enabled = False
      FRM_ING_BONOS.Grd_Compra_Bonos.Enabled = False
      ...
      FRM_ING_BONOS.FTB_VALOR_COLOCACION.CantidadDecimales = IIf(nMoneda <> 999 Or nMoneda <> 998 Or nMoneda <> 994, 2, 0)
      ...
      FRM_ING_BONOS.FTB_VALOR_COLOCACION.Text = Format(Valor_Colocacion_G, IIf(nMoneda <> 999 Or nMoneda <> 998 Or nMoneda <> 994, GLB_Formato_Dec_USD, GLB_Formato_Entero))
      FRM_ING_BONOS.FRM_VALOR_ESTIMADO.Enabled = False
      FRM_ING_BONOS.FTB_VALOR_COLOCACION.Enabled = False
      ...
      With FRM_ING_CORFO
            ...
            Else
               ...
               Do While FUNC_LEE_RETORNO_SQL(vDatos_Retorno())
                  ...
                  .TBL_MENU.Buttons(3).Enabled = False
...
Total_op = 0
   ...
   If Trim(cTipo_Producto) = "BONOS" Or Trim(cTipo_Producto) = "LETRA" Then
    ...
    Valor_Colocacion_G = 0
      ...
      FRM_ING_BONOS.FTB_VALOR_COLOCACION.Text = Format(Valor_Colocacion_G, IIf(nMoneda <> 999 Or nMoneda <> 998 Or nMoneda <> 994, GLB_Formato_Dec_USD, GLB_Formato_Entero))
      FRM_ING_BONOS.FRM_VALOR_ESTIMADO.Enabled = False
      FRM_ING_BONOS.FTB_VALOR_COLOCACION.Enabled = True
