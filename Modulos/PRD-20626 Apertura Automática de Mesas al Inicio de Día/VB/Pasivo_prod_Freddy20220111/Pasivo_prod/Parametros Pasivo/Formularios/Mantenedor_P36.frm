...
Begin VB.Form Mantenedor_P36 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin BACControles.TXTNumero FTB_Monto_inscrito 
         ...
         MarcaTexto      =   -1  'True
      End
      Begin BACControles.TXTNumero FTB_gasto_fact 
         Height          =   315
         Left            =   3120
         TabIndex        =   22
         Top             =   1170
...
Private Sub TXT_Fecha_inscripcion_Change()
If Format(TXTFecha_limite_para_la_colocacion.Text, "yyyymmdd") < Format(TXT_Fecha_inscripcion.Text, "yyyymmdd") Then
   'MsgBox "Fecha Limite no puede ser menor que fecha de inscripcion, Revisar", vbInformation
   TXTFecha_limite_para_la_colocacion.Text = TXT_Fecha_inscripcion.Text
'   TXTFecha_limite_para_la_colocacion.SetFocus
   Exit Sub
End If
End Sub
...
Private Sub TXTFecha_limite_para_la_colocacion_Change()
If Format(TXTFecha_limite_para_la_colocacion.Text, "yyyymmdd") < Format(TXT_Fecha_inscripcion.Text, "yyyymmdd") Then
   MsgBox "Fecha Limite no puede ser menor que fecha de inscripcion, Revisar", vbInformation
   TXTFecha_limite_para_la_colocacion.Text = TXT_Fecha_inscripcion.Text
   TXTFecha_limite_para_la_colocacion.SetFocus
...
Numero_de_inscripcion = Me.TxtNumero_de_inscripcion.Text & "|"
   ...
   GLB_Envia = Array()
   AddParam GLB_Envia, Me.TxtSerie.Text
   AddParam GLB_Envia, Numero_de_inscripcion
   
   If BAC_SQL_EXECUTE("sp_buscar_P36", GLB_Envia) Then
   
      If BAC_SQL_FETCH(vDatos_Retorno()) Then
            ...
            Else
                ...
                FTB_gasto_fact.Text = vDatos_Retorno(10)
...
Numero_de_inscripcion = Me.TxtNumero_de_inscripcion.Text & "|"
   ...
   GLB_Envia = Array()
   AddParam GLB_Envia, Me.TxtSerie.Text
   AddParam GLB_Envia, CInt(Me.TxtClasificadora_de_Riesgo1.Text)
   AddParam GLB_Envia, Me.TxtClasificacion_de_Riesgo1.Text
   AddParam GLB_Envia, CInt(Me.TxtClasificadora_de_Riesgo2.Text)
   AddParam GLB_Envia, Me.TxtClasificacion_de_Riesgo2.Text
   AddParam GLB_Envia, Numero_de_inscripcion
   AddParam GLB_Envia, Me.TXT_Fecha_inscripcion.Text
   AddParam GLB_Envia, Me.TXTFecha_limite_para_la_colocacion.Text
   AddParam GLB_Envia, CDbl(FTB_Monto_inscrito.Text)
   AddParam GLB_Envia, CDbl(FTB_gasto_fact.Text)

   If BAC_SQL_EXECUTE("sp_Grabar_P36", GLB_Envia) Then
