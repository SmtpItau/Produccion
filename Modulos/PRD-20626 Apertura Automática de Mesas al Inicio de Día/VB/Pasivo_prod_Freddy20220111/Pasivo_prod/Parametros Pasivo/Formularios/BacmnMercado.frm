...
Begin VB.Form BacmnMercado 
   ...
   Begin MSComctlLib.ImageList Img_opciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":2EFA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":3361
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":3857
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":3CEA
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":41D2
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":46E5
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":4BB8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacmnMercado.frx":507E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "BacmnMercado"
      ...
      With grilla
         ...
         For Fila% = 1 To .Rows - 1
            If Trim$(.TextMatrix(Fila%, 0)) <> "" Then
               ...
               If Not BAC_SQL_EXECUTE("Sp_Graba_ValoresMoneda_extranjera", Envia) Then
...
Public Function LeerMoneda(CodMon As Integer) As Boolean
    ...
    If Not BAC_SQL_EXECUTE("Sp_MNLeer_extranjera", Envia) Then Exit Function
...
On Error GoTo ErrMDB
   ...
   If Not BAC_SQL_EXECUTE("Sp_Trae_ValoresMoneda_Extranjera", Envia) Then
       Exit Function
   End If
...
'               itbano.Enabled = True
 ...
 '               itbano.Text = Trim(Year(gsbac_fecp))
               cmbano.Text = Trim(Year(gsbac_fecp))
                cmbMes.ListIndex = Month(gsbac_fecp) - 1
                ''LimpiaData
                MsgBox "Moneda no es extranjera", vbInformation
                TxtCodigo.SetFocus
            End If
