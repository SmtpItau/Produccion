...
Begin VB.Form FRM_MAN_TIPO_CLIENTE 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantención de Tipo de Cliente"
   ClientHeight    =   3690
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7005
   Icon            =   "FRM_MAN_TIPO_CLIENTE.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VSFlex8LCtl.VSFlexGrid Grd_Ingreso 
      ...
      FormatString    =   $"FRM_MAN_TIPO_CLIENTE.frx":2EFA
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin MSComctlLib.ImageList Img_opciones 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":2F99
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":3400
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":38F6
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":3D89
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":4271
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":4784
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":4C57
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":511D
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":5614
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":5A0D
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":5E03
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":6340
               Key             =   ""
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":6801
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":6CB7
               Key             =   ""
            EndProperty
            BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":70FB
               Key             =   ""
            EndProperty
            BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_TIPO_CLIENTE.frx":753D
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "FRM_MAN_TIPO_CLIENTE"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'  Autor          : Pamela Farías
'  Descripción    : Mantención de Tipo de Cliente
...
End Function
Private Function FUNC_GRABAR_TIPO_CLIENTE()
...
If Not BAC_SQL_EXECUTE("BEGIN TRANSACTION") Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
     ...
     If .RowHidden(nIndice) = True Then
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_TIPO_CLIENTE", Envia) Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
      ...
      If .RowHidden(nIndice) = False And Trim(.TextMatrix(nIndice, 0)) <> "" Then
         ...
         AddParam Envia, IIf(Trim(.TextMatrix(nIndice, 2)) = "", 0, Val(.TextMatrix(nIndice, 2)))
         AddParam Envia, .TextMatrix(nIndice, 3)
      
         If Not BAC_SQL_EXECUTE("SP_ACT_TIPO_CLIENTE", Envia) Then GoTo Errores
...
Private Function FUNC_TRAER_TIPO_CLIENTE()

With Grd_Ingreso

      If Not BAC_SQL_EXECUTE("SP_CON_TRAER_TIPO_CLIENTE") Then
   ...
   Case vbKeyDelete
      ...
      If .Row <> 0 Then
        ...
        Else
               ...
               If Not BAC_SQL_EXECUTE("SP_DEL_TIPO_CLIENTE", Envia) Then Exit Sub
