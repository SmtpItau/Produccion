...
Begin VB.Form FRM_MAN_MONEDA_TIPO 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantención de Tipo de Moneda"
   ClientHeight    =   3720
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5820
   Icon            =   "FRM_MAN_MONEDA_TIPO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VSFlex8LCtl.VSFlexGrid Grd_Ingreso 
      ...
      FormatString    =   $"FRM_MAN_MONEDA_TIPO.frx":2EFA
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin MSComctlLib.ImageList Img_opciones 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":2F4D
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":33B4
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":38AA
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":3D3D
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":4225
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":4738
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":4C0B
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":50D1
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":55C8
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":59C1
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":5DB7
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":62F4
               Key             =   ""
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":67B5
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":6C6B
               Key             =   ""
            EndProperty
            BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":70AF
               Key             =   ""
            EndProperty
            BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FRM_MAN_MONEDA_TIPO.frx":74F1
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "FRM_MAN_MONEDA_TIPO"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'  Autor          : Pamela Farías
'  Descripción    : Mantención de Tipo de Moneda
...
Private Function FUNC_GRABAR_TIPO_MONEDA()
...
If Not BAC_SQL_EXECUTE("BEGIN TRANSACTION") Then GoTo Errores
   ...
   For nIndice = 1 To .Rows - 1
     ...
     If .RowHidden(nIndice) = True Then
            ...
            If Not BAC_SQL_EXECUTE("SP_DEL_MONEDA_TIPO", Envia) Then GoTo Errores
  ...
  For nIndice = 1 To .Rows - 1
    ...
    If .RowHidden(nIndice) = False And Trim(.TextMatrix(nIndice, 0)) <> "" Then
         ...
         If Not BAC_SQL_EXECUTE("SP_ACT_MONEDA_TIPO", Envia) Then GoTo Errores
...
Private Function FUNC_TRAER_TIPO_MONEDA()

With Grd_Ingreso

      If Not BAC_SQL_EXECUTE("SP_CON_MONEDA_TIPO") Then
   ...
   Case vbKeyDelete
      ...
      If .Row <> 0 Then
        ...
        Else
               ...
               If Not BAC_SQL_EXECUTE("SP_DEL_MONEDA_TIPO", Envia) Then Exit Sub
...
Select Case Button.Index
   Case 1
      If FUNC_VALIDA_BLANCOS Then
         ...
         Grd_Ingreso.TopRow = Grd_Ingreso.Row
         Grd_Ingreso.Col = 0
         Grd_Ingreso.Refresh
       Else
         MsgBox "Hay registros en Blanco", vbOKOnly + vbInformation
   ...
   Case 2
      If Grd_Ingreso.Row <> 0 Then
      
        If Trim(Grd_Ingreso.TextMatrix(Grd_Ingreso.Row, 0)) = "" And Trim(Grd_Ingreso.TextMatrix(Grd_Ingreso.Row, 1)) = "" Then
          Grd_Ingreso.RemoveItem (Grd_Ingreso.Row)
        Else
        
               Envia = Array()
               AddParam Envia, Val(Grd_Ingreso.TextMatrix(Grd_Ingreso.Row, 0))
               AddParam Envia, "S"
               ...
               Do While BAC_SQL_FETCH(Datos())
                  ...
                  If Datos(1) = "NO" Then
                     MsgBox Datos(2), vbOKOnly + vbCritical
                  Else
                     Grd_Ingreso.RowHidden(Grd_Ingreso.Row) = True
                  End If
               Loop
