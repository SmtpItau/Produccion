...
Global Const MDTC_COD_CONTRAPARTE = 552
Global Const MDTC_COD_EMPR_CONTRA = 553
...
Global gsbac_fecAnt             As Date  'PRD-10449
...
Global resetea As String
Global tipo_clave  As String
Global largo_clave As Integer
Global nom_usuario As String



'Variables para Log_Auditoria
'----------------------------
Global logFila, logColumna As Integer
