...
Control:
    ...
    MsgBox "Problemas para Generar Protocolo de Contrato!. Referido a número " & BACSwap.Crystal.Err.Number & ". " & vbcrl _
    & "Descripción: " & BACSwap.Crystal.LastErrorString, vbCritical, TITSISTEMA
