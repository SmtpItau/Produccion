   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMntApoderado.frx":093C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMntApoderado.frx":0D94
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMntApoderado.frx":11EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMntApoderado.frx":1508
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMntApoderado.frx":1824
            Key             =   ""
         EndProperty
      EndProperty
   End
...
If Not Fecha.Visible Then Exit Sub
    Dim c As Long
    Dim f As Long
    With Grilla
    c = .Col
...
Private Sub Form_Load()
   ...
   Grilla.Rows = 2
    Fecha.Text = Format(gsbac_fecp, gsc_FechaDMA)
    Fecha.Visible = False
...
Private Sub editarfecha()

With Grilla

     .Col = 6
     Fecha.Text = .TextMatrix(.Row, .Col)
     Fecha.Top = .CellTop + 100
     Fecha.Left = .CellLeft
     Fecha.Width = .CellWidth
...
If .Col = 5 Then             ' e-mail
    ...
    If KeyAscii > 0 And KeyAscii <> 27 Then
        ...
        PROC_POSICIONA_TEXTO Grilla, Txtemail
        .Enabled = False
        Txtemail.Visible = True
        If KeyAscii = 13 Then
            Txtemail.Text = .TextMatrix(.Row, .Col)
            SendKeys "{END}"
        Else
            Txtemail.Text = UCase(Chr(KeyAscii))
            SendKeys "{RIGHT}" 'Comienzo Izquierda
        End If
        Txtemail.SetFocus
   ...
   If Controla_RUT(txtRut, txtDigito) = True Then
      ...
      If objCliente.LeerxRut(objCliente.clrut, objCliente.clcodigo) Then
         ...
         If objCliente.clrut <> 0 Then
            'TxtNombre.Text = objCliente.clnombre --Original
...
With Grilla
    ...
    If KeyAscii = 13 Then
          ...
          .TextMatrix(.Row, .Col) = Txtemail.Text
            Txtemail.Text = ""
           .Enabled = True
...
Private Sub txtRut_DblClick()
    ...
    If Val(gsCodigo$) = 97023000 And gsCodCli = 1 Then
...
Public Function CargarParam_Ap(Grillas As Object)
     ...
     With Grillas
         ...
         .ColWidth(4) = 10          'MARCA
         .ColWidth(5) = 3500        ' e-mail
         .ColWidth(6) = 1500 'fecha_escritura
