...
Begin VB.Form RIESGOS_NORMATIVOS 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Items de Riesgo Normativo."
   ClientHeight    =   5235
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5865
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RIESGOS_NORMATIVOS.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RIESGOS_NORMATIVOS.frx":0EDA
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RIESGOS_NORMATIVOS"
...
Private Function DeleteItems(xItems As Long) As Boolean
   ...
   If MsgBox("Se eliminara un Items de Riesgo Normativo  " & xItems & " " & Grid.TextMatrix(Grid.RowSel, 1) & vbCrLf & " ¿ esta seguro ?", vbQuestion + vbYesNo, App.Title) = vbNo Then
      Exit Function
   End If
   ...
   If Not Bac_Sql_Execute("SP_RIESGO_NORMATIVO", Envia) Then
...
Private Function Verificacion_Llave(nValor As Long) As Boolean
   ...
   For nContador = 1 To Grid.Rows - 1
      If Val(Grid.TextMatrix(nContador, 0)) = nValor Then
