...
Begin VB.Form BacLinPlazo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Linea por Plazo"
   ClientHeight    =   4815
   ClientLeft      =   2970
   ClientTop       =   3210
   ClientWidth     =   7875
   Icon            =   "BacLinPlazo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4815
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacLinPlazo.frx":000C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacLinPlazo.frx":0EE6
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacLinPlazo.frx":1DC0
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "BacLinPlazo"
    ...
    Select Case Button.Index
        Case 1
            ...
            If cOptraerDatos = 0 Then
                rutcli = CDbl(Format(BacLinCreGen3.TxtRut.Text, FEntero))
                codcli = Format(BacLinCreGen3.TxtCodCli.Text, FEntero)
                IdSist = Trim(Right(BacLinCreGen3.Grid.TextMatrix(BacLinCreGen3.Grid.Row, 0), 5))
            Else
                rutcli = CDbl(Format(BacLinCreGen3.TxtRut2.Text, FEntero))
                codcli = Format(BacLinCreGen3.TxtCodCli2.Text, FEntero)
                IdSist = Trim(Right(BacLinCreGen3.Grid2.TextMatrix(BacLinCreGen3.Grid2.Row, 0), 5))
            End If
            ...
            Envia = Array("E", rutcli, codcli, IdSist)
...
Private Function CargarGrilla()
    ...
    Titulo3 = Array("0", " ", " ", " ", " ", "0", "0", BacLinCreGen3.Grid.TextMatrix(BacLinCreGen3.Grid.Row, 5), "0", "0", "0")
    
    Call PROC_CARGARGRILLA(Grid, 315, 215, Anchos, Titulo1, , Titulo2)

    Me.Tag = Format(BacLinCreGen3.Grid.TextMatrix(BacLinCreGen3.Grid.Row, 5), FDecimal)
    LabTotLin.Caption = Format(BacLinCreGen3.Grid.TextMatrix(BacLinCreGen3.Grid.Row, 5), FDecimal)
...
Private Function Calculo()
    ...
    LabTotLin.Caption = Format(BacLinCreGen3.LabTotLin.Text, FDecimal)
...
Private Function CargaComboProducto(sSistema As String, Col As String)
    ...
    If sSistema = "BEX" And Col = 2 Then
        If Bac_Sql_Execute("BacLineas.dbo.sp_instrumentos_bonex") Then
            CmbCombo.Clear
            Do While Bac_SQL_Fetch(Datos())
                CmbCombo.AddItem Datos(2) & Space(100) & Datos(1)
           Loop
