...
Private Sub ProcLeeCurvas()
   ...
   If Not Bac_Sql_Execute("BacTraderSuda..SP_MNT_CURVA_CAPTA_IBS", Envia) Then
...
Private Sub Grid_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = vbKeyReturn Then
      Select Case Grid.ColSel
         Case 0
            Call PROC_POSICIONA_TEXTO(Grid, cmbMonedas)
...
Private Sub Grabacion()
   ...
   AddParam Envia, CDbl(0)
   AddParam Envia, CDbl(miFiltro)
   If Not Bac_Sql_Execute("BacTraderSuda.dbo.SP_MNT_CURVA_CAPTA_IBS", Envia) Then
