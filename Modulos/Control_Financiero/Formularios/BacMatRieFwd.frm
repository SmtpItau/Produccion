...
Begin VB.Form BacMatRieFwd 
   ...
   ClientTop       =   2415
   ClientWidth     =   4620
   Icon            =   "BacMatRieFwd.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   MouseIcon       =   "BacMatRieFwd.frx":000C
   ScaleHeight     =   4860
   ScaleWidth      =   4620
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.Frame marco1 
         ...
         Begin VB.ComboBox CmbMoneda2 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "BacMatRieFwd.frx":0316
            Left            =   1200
            List            =   "BacMatRieFwd.frx":0318
         ...
         Begin VB.ComboBox CmbProducto 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "BacMatRieFwd.frx":031A
            Left            =   1200
            List            =   "BacMatRieFwd.frx":031C
            Style           =   2  'Dropdown List
            TabIndex        =   0
            Top             =   150
            Width           =   3270
         ...
         Begin VB.ComboBox Cmbmoneda 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "BacMatRieFwd.frx":031E
            Left            =   1200
            List            =   "BacMatRieFwd.frx":0320
            Style           =   2  'Dropdown List
            TabIndex        =   1
            Top             =   510
            Width           =   3270
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      EndProperty
      BorderStyle     =   1
      MouseIcon       =   "BacMatRieFwd.frx":0322
      OLEDropMode     =   1
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMatRieFwd.frx":063C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMatRieFwd.frx":1516
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMatRieFwd.frx":23F0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMatRieFwd.frx":32CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "BacMatRieFwd.frx":41A4
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "BacMatRieFwd"
...
Dim datos()
   ...
   If Right(CmbProducto.Text, 1) = "S" Then
    AddParam Envia, CmbMoneda2.ItemData(CmbMoneda2.ListIndex)
   Else
    AddParam Envia, 0
   End If

    If Not Bac_Sql_Execute("SP_MATRIZRIESGO_BUSCA", Envia) Then
        Exit Sub
    End If
...
With Grid
    ...
    For ROWGRID = 2 To .Rows - 1
      ...
      If Not Bac_Sql_Execute("SP_MATRIZRIESGO_GRABA", Envia) Then
...
End With
    ...
    Call GRABA_LOG_AUDITORIA(1, (gsBAC_Fecp), gsBac_IP, gsBAC_User, "SCF", "Opt30004", "01", "GRABA MATRIZ DE RIESGO", "MATRIZ_RIESGO", "", ValNue)
   ...
   AddParam Envia, Cmbmoneda.ItemData(Cmbmoneda.ListIndex)
    ...
    If Existeope = "SI" Then
        ...
        If res = 6 Then
            ...
            Call ValAntNue
            Call GRABA_LOG_AUDITORIA(1, (gsBAC_Fecp), gsBac_IP, gsBAC_User, "SCF", "Opt30004", "03", "ELIMINA MATRIZ DE RIESGO", "MATRIZ_RIESGO", ValAnt, "")
...
Sub Cargar()
   ...
   If Cmbmoneda.ListCount = -1 Then
      ...
      Exit Sub
   End If
   If CmbMoneda2.ListCount = -1 Then
      MsgBox "No existen monedas cargadas"
      Exit Sub
   End If
   ...
   For nCont = 0 To CmbMoneda2.ListCount - 1

      If CmbMoneda2.ItemData(nCont) = 142 Then
         CmbMoneda2.ListIndex = nCont
         Exit For
      End If
   Next
       
   If Right(CmbProducto.Text, 1) = "N" Then
...
Else
    CmbMoneda2.Enabled = False
End If
Label4.Caption = Right(CmbProducto.Text, 1)
End Sub
...
Private Sub Form_Load()
   ...
   If Bac_Sql_Execute("SP_MATRIZRIESGO_AYUDAPRODUCTO", Envia) Then
      Do While Bac_SQL_Fetch(datos())
         CmbProducto.AddItem datos(2) & Space(50) & datos(4)
         CmbProducto.ItemData(CmbProducto.NewIndex) = datos(1)
      Loop
   End If
   ...
   If Bac_Sql_Execute("SP_TRAEMONEDAS") Then
      Do While Bac_SQL_Fetch(datos())
         ...
         CmbMoneda2.AddItem datos(2)
         CmbMoneda2.ItemData(CmbMoneda2.NewIndex) = datos(1)
      Loop
   End If
...
If Mid(Label4.Caption, 1, 1) = "S" Then
    Label4.Caption = "SI"
Else
    Label4.Caption = "NO"
End If
