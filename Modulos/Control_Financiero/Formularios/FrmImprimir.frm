...
Begin VB.Form FrmImprimir 
   ...
   Caption         =   "Bitacora de Autorizacion"
   ClientHeight    =   1695
   ClientLeft      =   2670
   ClientTop       =   1935
   ClientWidth     =   7920
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmImprimir.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmImprimir.frx":0EE6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmImprimir.frx":1200
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Select Case UCase(Button.Index)
     Case 1, 2
            ...
            BacControlFinanciero.CryFinanciero.ReportFileName = gsRPT_Path & "rptbitaco.rpt"
            BacControlFinanciero.CryFinanciero.StoredProcParam(0) = Format(txtFechaInicio.Text, "yyyymmdd")
            BacControlFinanciero.CryFinanciero.StoredProcParam(1) = Format(txtFechaTermino.Text, "yyyymmdd")
