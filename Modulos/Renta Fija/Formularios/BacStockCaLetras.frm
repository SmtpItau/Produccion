...
Begin VB.Form BacStockCaLetras 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Informe Stock de cartera Letras Propia Emisión"
   ClientHeight    =   1500
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   4890
   Icon            =   "BacStockCaLetras.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "BacStockCaLetras.frx":030A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "BacStockCaLetras.frx":0626
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "BacStockCaLetras"
...
On Error GoTo ERR_Imprime_RPT_Stock
    ...
    BacTrader.bacrpt.ReportFileName = RptList_Path & "stockcartasemi.rpt"
    BacTrader.bacrpt.StoredProcParam(0) = Format(Me.TXTFecha.text, "yyyymmdd")
    BacTrader.bacrpt.WindowTitle = "CARTERA LETRAS PROPIA EMISION"
