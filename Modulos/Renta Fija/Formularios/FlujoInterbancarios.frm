...
Begin VB.Form FlujoInterbancarios 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Flujo Interbancario"
   ClientHeight    =   5475
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6990
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FlujoInterbancarios.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FlujoInterbancarios.frx":0452
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FlujoInterbancarios.frx":08A4
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FlujoInterbancarios.frx":0BBE
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FlujoInterbancarios.frx":1010
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin Threed.SSFrame SSFrame1 
         ...
         Begin Threed.SSFrame SSFrame2 
            ...
            Begin BacControles.txtNumero TxtRutCliente 
               ...
               CantidadDecimales=   "0"
               Max             =   "999999999"
               MouseIcon       =   "FlujoInterbancarios.frx":132A
               MousePointer    =   99
            End
   ...
   End
End
Attribute VB_Name = "FlujoInterbancarios"
...
Private Sub cmbproducto_Click()
   ...
   If TxtRutCliente.Text <> "0" And Len(TxtRutCliente.Text) > 6 And CmbProducto.Text <> "" Then
...
Private Sub Form_Load()
   ...
   CmbProducto.AddItem "ICOL"
   CmbProducto.AddItem "ICAP"
   SSProceso.Visible = False
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
   ...
   Select Case Button.Index
      ...
      Case 2
            ...
            If Not Existe_Cliente(TxtRutCliente.Text) Then

               MsgBox "El cliente no existe", vbExclamation, TITSISTEMA
...
Private Sub TxtRutCliente_DblClick()
   ...
   If giAceptar = True Then
      ...
      TxtRutCliente.Text = gsrut$  ' + "-" + ltDigito
      TxtRutCliente.Tag = gscodigo
...
Sub Carga_Grilla()
   ...
   With Grilla
      ...
      .Col = 4
      .CellFontBold = True
      .TextMatrix(0, 1) = "NºDia"
      .TextMatrix(0, 2) = "Valor"
      .TextMatrix(0, 3) = "NºDia"
   ...
   Dim X           As Integer
      ...
      With Grilla
         ...
         For I = I To DiasDelMes(Val(Cdias), Val(iblano))
            ...
            Dia = IIf(Len(Trim(Str(I))) < 2, "0" + Trim(Str(I)), Str(I))
            .TextMatrix(Fila, 3) = Trim(Dia + "/" + Cdias + "/" + Trim(Str(iblano)))
            .TextMatrix(Fila, 4) = 0
            Fila = Fila + 1
         ...
         AddParam Envia, CmbProducto.Text
         
         If Bac_Sql_Execute("Sp_FlujoInterbancario_Busca ", Envia) Then
            ...
            While Bac_SQL_Fetch(Datos)
               ...
               For I = 1 To .Rows - 1
                  ...
                  If .TextMatrix(I, 3) = "" Then Exit For
               
                  .TextMatrix(I, 4) = Format(Datos(X), "###,##0")
...
Dim I As Integer
   ...
   With Grilla
         ...
         Envia = Array()
         AddParam Envia, CDbl(TxtRutCliente.Text)
         AddParam Envia, CDbl(TxtRutCliente.Tag)
         AddParam Envia, txtFecha.Text
         AddParam Envia, CmbProducto.Text
         ...
         For I = 1 To .Rows - 1
            ...
            If .TextMatrix(I, 4) <> "" Then
               ...
               AddParam Envia, CDbl(.TextMatrix(I, 4))
            
            End If
         
         Next I
         
         Grabar = Bac_Sql_Execute("Sp_FlujoInterbancario_Graba", Envia)
...
Function Existe_Cliente(xRut As Double) As Boolean

   Envia = Array()
   AddParam Envia, CDbl(xRut)
   
   Existe_Cliente = Bac_Sql_Execute("Sp_FlujoInterBancario_TraeCliente", Envia)
   ...
   If Existe_Cliente Then
      ...
      If Bac_SQL_Fetch(Datos()) Then
         ...
         If Datos(1) <> "NO EXISTE" Then
            ...
            TxtRutCliente.Text = Datos(1)
            TxtRutCliente.Tag = Datos(2)
