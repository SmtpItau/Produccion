...
Function Bac_Informe_Basilea(ByVal dFecha As Date, xDestino As DestinationConstants)
   ...
   BacTrader.bacrpt.WindowTitle = "Informe Basilea Derivados"
   BacTrader.bacrpt.ReportFileName = RptList_Path & "InformeBasileaDerivados.rpt"
                  '--> Store Procedure : DBO.GENERA_INFORME_BASILEA_DERIVADOS
   BacTrader.bacrpt.Destination = xDestino
   BacTrader.bacrpt.StoredProcParam(0) = Format(dFecha, "yyyy-mm-dd 00:00:00.000")
...
Exit Function
ErrorInforme:
   MsgBox "Error Impresión" & vbCrLf & vbCrLf & BacTrader.bacrpt.LastErrorString, vbExclamation, App.Title
End Function
