...
Function Lineas_ChequearGrabar(cSist As String, cTipOper As String, nNumPantalla As Double _
                            ...
                            , Optional nMetodologiaLCR As Integer = 0) '10967
    ...
    AddParam Envia, Replace(nTipCambio, ",", ".")       'Tipo Cambio
...
'    AddParam Envia, nCodEmisor                          'Codigo Emisor
    ...
    AddParam Envia, Replace(nTir, ",", ".")                                ' Tir del Papel
    AddParam Envia, Replace(nTasaPact, ",", ".")                           ' Tasa pacto
